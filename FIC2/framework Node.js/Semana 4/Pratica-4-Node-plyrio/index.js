...
async function marcarTarefaConcluida(){
  ...
  try{
    await axios.api.put/** inclua aqui o método put */(`/tarefas/${id}`, {
      id: id,
...
async function excluirTarefa(){
  ...
  try{
    await axios.api.delete/** inclua aqui o método delete */(`/tarefas/${id}`);
...
async function listarTarefasPendentes(){
  ...
  try{
    ...
    var response = await axios.api.get/** inclua aqui o método get */('/tarefas');
...
async function obterTarefa(id){
  ...
  var response = await axios.api.get/** inclua aqui o método get */(`/tarefas/${id}`);
